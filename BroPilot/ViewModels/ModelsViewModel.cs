...
namespace BroPilot.ViewModels
{
    public class ModelsViewModel : BaseViewModel
    {
        ...
        public ModelsViewModel(IModelsManager modelsManager)
        {
        ...
        private readonly IModelsManager modelsManager;
        ...
        {
            var models = modelsManager.LoadModels();
        ...
        {
            var models = this.models.ToArray();
            modelsManager.SaveModels(models);
        }
    }
}
