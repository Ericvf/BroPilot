...
namespace BroPilot.Extension
{
    ...
    [Guid(BroPilotExtensionPackage.PackageGuidString)]
    [ProvideMenuResource("Menus.ctmenu", 1)]
    [ProvideToolWindow(typeof(BroPilot.Extension.ToolWindow1))]
    public sealed class BroPilotExtensionPackage : AsyncPackage
    {
        /// <summary>
        /// BroPilot.ExtensionPackage GUID string.
        /// </summary>
        ...
        protected override async Task InitializeAsync(CancellationToken cancellationToken, IProgress<ServiceProgressData> progress)
        {
            ...
            await BroPilot.Extension.ToolWindow1Command.InitializeAsync(this);
        }
